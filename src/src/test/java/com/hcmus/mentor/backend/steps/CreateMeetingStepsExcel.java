...
public class CreateMeetingStepsExcel {
    ...
    @Khi("người dùng chọn Lịch hẹn, người dùng bấm dấu cộng để thêm 1 cuộc hẹn tại file Excel {string}")
    public void openFormMeeting(String excelFilePath) throws InterruptedException, IOException {
        List<Map<String, String>> dataList = readExcelData(excelFilePath);
    ...
    public void assertInformation(String excelFilePath) throws InterruptedException, IOException {
        ...
        Thread.sleep(1000);
        List<Map<String, String>> expectedDataList = readExcelData(excelFilePath);
...
//        clockElement = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[contains(@class,'MuiClock-squareMask css-de3exi-MuiClock-squareMask')]")));
    ...
    private List<Map<String, String>> readExcelData(String filePath) throws IOException {
